    ...
    public void onBindViewHolder(final FlowerViewHolder holder, int position) {
        ...
        holder.mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mIntent.putExtra("Details",mFlowerList.get(holder.getAdapterPosition()).getFlowerDetails());
                mIntent.putExtra("Reviews",(Serializable) mFlowerList.get(holder.getAdapterPosition()).getFlowerReview());
